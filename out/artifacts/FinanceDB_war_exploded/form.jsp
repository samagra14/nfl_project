...
<div class="container">
    <form action="FormServlet" method="post">
        <h1>
            GST RCM<small>NFL Vijaipur</small></h1>
        ...
        <div class="form-group">
            <input type="text" name="SupplierName" required="required"/>
            <label class="control-label" for="input">Supplier Name</label><i class="bar"></i>
        </div>
        <div class="form-group">
            <textarea required="required"></textarea>
            <label class="control-label" for="textarea">Supplier Code</label><i class="bar"></i>
        </div>
        <div class="form-group">
            <textarea required="required"></textarea>
        ...
        <div class="form-group">
            <textarea required="required"></textarea>
            <label class="control-label" for="textarea">City</label><i class="bar"></i>
        </div>
        <div class="form-group">
            <textarea required="required"></textarea>
            <label class="control-label" for="textarea">Invoice Number</label><i class="bar"></i>
        </div>
        <div class="form-group">
            <textarea required="required"></textarea>
            <label class="control-label" for="textarea"> Item Name/Nature</label><i class="bar"></i>
        </div>

        <div class="form-group">
            <textarea required="required"></textarea>
            <label class="control-label" for="textarea">HSN Code</label><i class="bar"></i>
        </div>
        <div class="form-group">
            <textarea required="required"></textarea>
            <label class="control-label" for="textarea">Amount Rs</label><i class="bar"></i>
        </div>
        <div class="checkbox">
            <label>
        ...
        <div class="button-container">
            <button class="button" type="submit" value="submit"><span>Submit</span></button>
        </div>
    </form>
</div>
